...
const Textarea = (props) => {
  ...
  return (
    <div
      style={
        (mode.style, mode.collapse === 'd-block' ? {height: 'calc(100vh - 3rem)'} : {height: 'calc(100vh - 0.1rem)'} )}
      className="font-style container-fluid scroll px-0 m-0"
    >
      <div style={{height: 'calc(100% - 11.5%)'}} className="container-fluid p-0">
      ...
      <div style={{ width: "100%" }} className="d-flex justify-content-end">
        <Floatingicons
          ...
          handleAddDraft={props.handleAddDraft}
        />
      </div>
    </div>
  );
